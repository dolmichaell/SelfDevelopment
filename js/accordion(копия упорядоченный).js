(function (){
    ...
    init($($($('.accordion')[0]).children('.section').children('.section-button')));
    init($($($('.accordion')[1]).children('.section').children('.section-button')));
    init($($($('.accordion')[2]).children('.section').children('.section-button')));
    init($($($('.accordion')[3]).children('.section').children('.section-button')), true);
})();
