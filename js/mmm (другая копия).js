...
//=========================================================
	...
	//===============Всплывающее окно========================================
	var html, srcImg, data_id, keyImg, arrLength, trans, arr = [], array = [];
		html = '<div class="about-picture-all">' +
			'<div class="about-picture">' +
				...
				'<div class ="about-all-img">' +
					//'<div class="about-img"><img class="picture-img-button" src=#></div>' +
				'</div>' +
			'</div>' +
		'</div>';
	$(".work").append(html);
...
// НОВА Кнопки вперед назад===========================
	$(".about-button1").on("click", function (e) {
		...
		console.log(trans);
		//console.log(arr[keyImg]["posit"]);
		// trans = arr[keyImg]["posit"]
		//$(".about-all-img").attr("src",arr[keyImg]["src"])   css("transform", "translateX(20%)");
		trans = trans + 20;
		console.log("translateX("+ trans + "%)");
		$(".about-all-img").css("transform", "translateX("+ trans + "%)");
		//$(".about-all-img").css("transform", "translateX(20%)");
		$(".about-all-img").css("transition", "all 500ms");
		//$(".about-all-img").attr("src",arr[keyImg]["src"]);
